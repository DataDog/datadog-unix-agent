...
Returns CRITICAL if the NTP offset is greater than the threshold specified in `conf.yaml`, otherwise OK.
...
[3]: https://github.com/DataDog/datadog-unix-agent/blob/master/checks/bundled/ntp/datadog_checks/ntp/data/conf.yaml.default
