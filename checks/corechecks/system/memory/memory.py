# checks/corechecks/system/memory/memory.py
...
class MemoryCheck(AgentCheck):
    """
    Core system memory check.
    Converts byte values to MB and reports memory & swap metrics.
    """
